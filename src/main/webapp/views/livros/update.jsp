...
<title>Booki | Atualizar Livro</title>
</head>
<body>
	<main>
		<header class="header">
		...
		<div class="container py-3">
            <form action="./livro-update">
	            ...
	            <input type="hidden" id="id" name="id" class="form-control" value="${livro.id}" />
...
<!-- 	            </div> -->
	            ...
	            <div class="form-group mb-3">
	                ...
	                <input type="number" id="preco" name="preco" class="form-control" step="0.01" value="${livro.preco}" />
	            </div>
